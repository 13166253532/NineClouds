...
var M = require('../modules/doneTodo.modules')
var async = require('async')
module.exports = {
    selectDonelist:function (req,res,next) {
        ...
        sql.getConnection(function (err,conn) {
            ...
            M.selectDonelist(conn,approvalId,pagerCount,pagerNum,conDition,companyId,function (result) {
